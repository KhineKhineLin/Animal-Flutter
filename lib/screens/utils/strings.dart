class Strings {
  ...
  static const String READY_TO_WATCH_DESC =
      'A planet is a global leader in real life entertainment, serving a passionate audience of super fans around the world with content that inspires, informs and entertains';
  static const String START_ENJOYING = 'Start Enjoying';
  static const String LAST_STEP_TO_ENJOY = 'Last step to enjoy';
  static const chooseAPlan = 'Choose a plan';
  ...
  static const String loremIpsum =
      'Animals (also called Metazoa) are multicellular eukaryotic organisms that form the biological kingdom Animalia. With...';
}
